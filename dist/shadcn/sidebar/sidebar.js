...
import { useIsMobile as r } from "../hooks/use-mobile.js";
import { Input as i } from "../input/input.js";
import { Separator as a } from "../separator/separator.js";
import { Sheet as o, SheetContent as s, SheetDescription as c, SheetHeader as l, SheetTitle as u } from "../sheet/sheet.js";
...
var x = "sidebar_state", S = 604800, C = "16rem", w = "18rem", T = "3rem", E = "b", D = b.createContext(null), O = () => {
	...
	return e;
}, k = ({ defaultOpen: e = !0, open: n, onOpenChange: i, className: a, style: o, children: s, ...c }) => {
	let l = r(), [u, d] = b.useState(!1), [f, p] = b.useState(e), h = n ?? f, _ = b.useCallback((e) => {
		let t = typeof e == "function" ? e(h) : e;
		i ? i(t) : p(t), document.cookie = `${x}=${t}; path=/; max-age=${S}`;
	}, [i, h]), v = b.useCallback(() => l ? d((e) => !e) : _((e) => !e), [
		l,
		_,
		d
	]);
...
}, A = ({ side: e = "left", variant: n = "sidebar", collapsible: r = "offcanvas", className: i, children: a, ...d }) => {
	...
	return r === "none" ? /* @__PURE__ */ g("div", {
		...
		children: /* @__PURE__ */ _(s, {
			...
			children: [/* @__PURE__ */ _(l, {
				className: "sr-only",
				children: [/* @__PURE__ */ g(u, { children: "Sidebar" }), /* @__PURE__ */ g(c, { children: "Displays the mobile sidebar." })]
			}), /* @__PURE__ */ g("div", {
