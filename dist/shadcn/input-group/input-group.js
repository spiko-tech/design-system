...
import "react";
//#region src/shadcn/input-group/input-group.tsx
var o = ({ className: t, ...n }) => /* @__PURE__ */ i("div", {
	...
	...n
}), s = a("flex h-auto cursor-text items-center justify-center gap-2 py-1.5 text-sm font-medium text-muted-foreground select-none group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-[calc(var(--radius)-5px)] [&>svg:not([class*='size-'])]:size-4", {
	variants: { align: {
...
}), c = ({ className: t, align: n = "inline-start", ...r }) => /* @__PURE__ */ i("div", {
	role: "group",
	...
	...r
}), l = a("flex items-center gap-2 text-sm shadow-none", {
	variants: { size: {
