...
const DropdownMenuItem = ({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 spiko-text-sm-regular outline-hidden select-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 data-[variant=destructive]:text-destructive-foreground data-[variant=destructive]:focus:bg-destructive/10 data-[variant=destructive]:focus:text-destructive-foreground dark:data-[variant=destructive]:focus:bg-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-text-secondary data-[variant=destructive]:*:[svg]:!text-destructive-foreground",
        className
      )}
      {...props}
    />
...
const DropdownMenuCheckboxItem = ({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 spiko-text-sm-regular outline-hidden select-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...(checked ? { checked } : {})}
      {...props}
...
const DropdownMenuLabel = ({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn('px-2 py-1.5 spiko-text-sm-medium data-[inset]:pl-8', className)}
      {...props}
    />
  );
};
...
const DropdownMenuSubTrigger = ({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        'flex cursor-default items-center rounded-sm px-2 py-1.5 spiko-text-sm-regular outline-hidden select-none focus:bg-accent focus:text-accent-foreground data-[inset]:pl-8 data-[state=open]:bg-accent data-[state=open]:text-accent-foreground',
        className
      )}
      {...props}
    >
